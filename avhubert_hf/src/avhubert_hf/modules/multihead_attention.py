"""
Multi-head attention module adapted from fairseq
"""
...
class MultiheadAttention(nn.Module):
    ...
    def __init__(
        ...
        q_noise=0.0,
        qn_block_size=8,
        # TODO fairseq can pass in Callable[[Tensor], Tensor] here instead
    ...
    def forward(
        ...
        attn_weights_float = torch.softmax(attn_weights, dim=-1, dtype=torch.float32)
    ...
    def get_incremental_state(
        ...
        return incremental_state.get(key, {}) if incremental_state is not None else None
